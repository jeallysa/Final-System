                ...
                <div class="modal-dialog">
                    <div class="panel panel-primary">
                        <div class="panel-heading" >
                            ...
                            <h4 class="panel-title" id="contactLabel"><span class="glyphicon glyphicon-info-sign"></span> Add New Machine</h4>
                        </div>
                               ...
                               <div class="row">
                                    <div class="col-md-6 form-group">
                                        <div class="form-group label-floating">
                                            ...
                                            <input class="form-control" type="text" name="brewer" required pattern="[a-zA-Z][a-zA-Z\s]*" required title="Brewer should only countain letters" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6 form-group">
                                        <div class="form-group label-floating">
