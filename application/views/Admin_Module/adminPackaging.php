                                             ...
                                             <tr>
                                                 ...
                                                 <td>
                                                     <div class="onoffswitch">
                                                        ...
                                                        <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deactivate<?php echo $row->package_id;?>">Deactivate</button>
                                                    ...
                                                    <?php else: ?>
                                                        <!-- Button to Activate -->
                                                        <button class="btn btn-success btn-sm" data-toggle="modal" data-target="#deactivate<?php echo $row->package_id;?>">Activate</button>
...
$(document).ready(function() {
    $('#example').DataTable({
		...
		buttons: [
			...
			/*{ "extend": 'pdf', title: 'Packaging Inventory', "text":'<i class="fa fa-file-pdf-o"></i> PDF',"className": 'btn btn-danger btn-xs',
                exportOptions: {
                    columns: [0, 1, 2, 3, 4, 5]
                },
                customize: function ( doc ) {
                doc.content[1].table.widths = ['14%','14%','18%','26%','14%','14%']
                }
            }*/
            { 
                "extend": 'pdf',
